...
def respuesta(bot, update):
    update.message.reply_text('Deberias buscar una actividad en la que te puedas distraer')
    return TYPING_CHOICE
...
#Agregue manejador de conversacion con los estados GENDER, PHOTO, LOCATION Y BIO
    conv_handler = ConversationHandler(
        ...
        states={
            CHOOSING: [RegexHandler('^(Nombre|Estado de animo|Promesa importante||Color favorito|Estado civil|Habilidad o pasatiemo...)$',
                                    regular_choice,
                                    pass_user_data=True),
                        ],
